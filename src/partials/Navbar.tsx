    ...
    <NavbarTwoColumns>
      <a href="/">
        <Logo
          ...
          name="Colin Kierans Portfolio"
        />
      </a>

      <NavMenu>
        <NavMenuItem href="/hobbies/">Hobbies</NavMenuItem>
        <NavMenuItem href="https://github.com/Vindexus">GitHub</NavMenuItem>
        <NavMenuItem href="mailto:colinkierans@gmail.com">Email</NavMenuItem>
      </NavMenu>
    </NavbarTwoColumns>
  </Section>
);
